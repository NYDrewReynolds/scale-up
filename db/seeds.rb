...
#
#   def create_categories
#     ["agriculture", "community", "education", "pizza", "dolphin", "cat", "dog", "monkey", "pony", "rhino", "whale", "asdf", "haha", "lol", "rofl"].each do |cat|
#       Category.create(title: cat, description: cat + " stuff")
#     end
#   end
#
...
#       loan_request.user_id = b.sample.id
#       LoanRequestsCategory.populate(1) do |lrc|
#         lrc.category_id = categories.sample.id
#         lrc.loan_request_id = loan_request.id
#       end
#     end
#   end
#
